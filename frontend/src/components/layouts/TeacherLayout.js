...
const TeacherLayout = ({ children, title }) => {
  ...
  const menuItems = [
    ...
    { path: '/teacher/results', icon: FileText, label: 'Results' },
    { path: '/teacher/leave', icon: Calendar, label: 'Apply Leave' },
  ];
          ...
          <aside className="absolute left-0 top-0 bottom-0 w-64 bg-white animate-slideIn">
            <div className="p-4 border-b border-gray-100 flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <span className="font-heading font-bold text-sm">Teacher Portal</span>
              </div>
